...
<body onload="selectedOptionCheck()">
	...
	<div class="left-top">
					...
					<li class="showSelect" style="margin-right:10px;">
						<input type="radio" id="new" name="select" style="display:none;" value="new" checked>
						<label for="new"><img src="resources/img/checkIcon.svg" width="14px" style="padding-right:6px;" id="new_icon_black">최신순</label>
					</li>
					
					<li class="showSelect">
						<input type="radio" id="best" name="select" style="display:none;" value="best">
						<label for="best"><img src="resources/img/check_gray.svg" width="14px" style="padding-right:6px;" id="best_icon_gray">인기순</label>
					</li>
				</ul>

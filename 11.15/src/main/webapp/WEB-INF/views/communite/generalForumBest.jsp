...
$(document).ready(function() {
    ...
    $('#new').on('click', function(){
			location.href = "generalForum";
    });
    
    $('#best').on('click', function(){
    	location.href = "generalForumBest";
    });
...
<body onload="selectedOptionCheck()">
	...
	<div class="left-top">
					...
					<li class="showSelect" style="margin-right:10px;">
						<input type="radio" id="new" name="select" style="display:none;" value="new" >
						<label for="new"><img src="resources/img/check_gray.svg" width="14px" style="padding-right:6px;" id="new_icon_gray">최신순</label>
					</li>
					
					<li class="showSelect">
						<input type="radio" id="best" name="select" style="display:none;" value="best" checked>
						<label for="best"><img src="resources/img/checkIcon.svg" width="14px" style="padding-right:6px;" id="best_icon_black">인기순</label>
					</li>
				</ul>
